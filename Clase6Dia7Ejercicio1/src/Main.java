...
public class Main {
    public static void main(String[] args) {
        ...
        //Proyecto realizado grupalmente con Alicia Martínez y Sol Lereah
        ...
        for(Vehiculo info : vehiculos){
            ...
            info.antiguedad();
            if (info instanceof Auto){
                System.out.println(((Electrico)info).cargarEnergia());
            }else if (info instanceof Camioneta){
                System.out.println(((Camioneta)info).recargarCombustible());
            } else if (info instanceof Moto) {
                System.out.println(((Moto)info).recargarCombustible());
            }
            System.out.println();
        }
